...
/**
 * The Dice class implements a set of polyhedral dice, as used in many 
 * pen-and-paper roleplaying games. It accepts dice with any positive number 
 * of sides.
 * 
 * @author	mdriesen
 */
public class Dice {
	/**
	 * Returns the result of a dice roll. The parameters <code>number</code>
	 * and <code>dice</code> should be positive, <code>mod</code> can be any integer. 
	 * If <code>number</code> or <code>dice</code> are not positive, this method 
	 * returns <code>mod</code>.
	 * 
