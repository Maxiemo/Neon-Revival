	...
	private class SpellListAction extends AbstractAction {
		...
		public void actionPerformed(ActionEvent e) {
			if(e.getActionCommand().equals("Add spell")) {
				RSpell rs = (RSpell)JOptionPane.showInputDialog(neon.editor.Editor.getFrame(), "Add spell:",
	...
	private class ItemListAction extends AbstractAction {
		...
		public void actionPerformed(ActionEvent e) {
			if(e.getActionCommand().equals("Add item")) {
				...
				RItem ri = (RItem)JOptionPane.showInputDialog(neon.editor.Editor.getFrame(), "Add item:",
