...
public class PowerEditor extends ObjectEditor implements ActionListener {
	...
	public PowerEditor(JFrame parent, RSpell.Power data) {
		...
		intervalField = new JFormattedTextField(NeonFormat.getIntegerInstance());
		...
		JLabel intervalHelpLabel = HelpLabels.getIntervalHelpLabel();
		layout.setVerticalGroup(
				...
				.addGroup(layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
						.addComponent(intervalLabel).addComponent(intervalField).addComponent(intervalHelpLabel))
				.addGap(10));
		layout.setHorizontalGroup(
				layout.createSequentialGroup()
				.addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING)
						.addComponent(nameLabel).addComponent(effectLabel).addComponent(sizeLabel).addComponent(rangeLabel)
						.addComponent(areaLabel).addComponent(durationLabel).addComponent(intervalLabel))
				.addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING, false)
						...
						.addComponent(durationField).addComponent(intervalField))
				.addGap(10)
				.addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING, false)
						.addComponent(nameHelpLabel).addComponent(effectHelpLabel).addComponent(sizeHelpLabel).addComponent(rangeHelpLabel)
						.addComponent(areaHelpLabel).addComponent(durationHelpLabel).addComponent(intervalHelpLabel)));
	...
	protected void load() {
		...
		intervalField.setValue(data.interval);
