...
public class PoisonEditor extends ObjectEditor implements ActionListener {
	private JTextField nameField;
	private JFormattedTextField sizeField, durationField;
	private JComboBox<Effect> effectBox;
	private JTextArea scriptArea;
	private RSpell data;
	
	public PoisonEditor(JFrame parent, RSpell data) {
		super(parent, "Poison: " + data.id);
		this.data = data;
		...
		layout.setHorizontalGroup(
				...
				.addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING)
						.addComponent(nameLabel).addComponent(effectLabel)
						.addComponent(sizeLabel).addComponent(durationLabel))
				.addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING, false)
						.addComponent(nameField, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
						.addComponent(effectBox).addComponent(sizeField).addComponent(durationField))
				.addGap(10)
				.addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING, false)
						.addComponent(nameHelpLabel).addComponent(effectHelpLabel)
						.addComponent(sizeHelpLabel).addComponent(durationHelpLabel)));
