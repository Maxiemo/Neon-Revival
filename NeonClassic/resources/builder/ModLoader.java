...
public class ModLoader {
	...
	private void initQuests(String... file) {
		try {
			for(String s : files.listFiles(file)) {
				...
				resources.addResource(new RQuest(quest.replace(".xml", ""), doc.getRootElement()), "quest");
			}
	...
	private void initBooks(String... file) {
		try {
			for(String s : files.listFiles(file)) {
				...
				resources.addResource(book, "text");
			}
		} catch(Exception e) { 
	...
	private void initCreatures(String... file) {
		if(files.exists(file)) {
			...
			for(Element c : creatures.getChildren()) {
				switch(c.getName()) {
				case "npc": resources.addResource(new RPerson(c)); break;
				case "list": resources.addResource(new LCreature(c)); break;
				default: resources.addResource(new RCreature(c)); break;
				}
			}
		}
	}
	...
	private void initItems(String... file) {
		if(files.exists(file)) {
			...
			for(Element e : items.getChildren()) {
				switch(e.getName()) {
				case "book":
				case "scroll": resources.addResource(new RItem.Text(e)); break;
				case "weapon": resources.addResource(new RWeapon(e)); break;
				case "craft": resources.addResource(new RCraft(e), "craft"); break;
				case "door": resources.addResource(new RItem.Door(e)); break;
				case "potion": resources.addResource(new RItem.Potion(e)); break;
				case "container": resources.addResource(new RItem.Container(e)); break;
				case "list": resources.addResource(new LItem(e)); break;
				case "armor":
				case "clothing": resources.addResource(new RClothing(e)); break;
				default: resources.addResource(new RItem(e)); break;
				}
			}
		}
	}
	...
	private void initTerrain(String... file) {
		...
		for(Element e : terrain.getChildren()) {
			resources.addResource(new RTerrain(e), "terrain");
		}		
	}
	...
	private void initThemes(String... file) {
		if(files.exists(file)) {
			...
			for(Element theme : themes.getChildren()) {
				...
				case "dungeon": resources.addResource(new RDungeonTheme(theme), "theme"); break;
				case "zone": resources.addResource(new RZoneTheme(theme), "theme"); break;
				case "region": resources.addResource(new RRegionTheme(theme), "theme"); break;
				}
			}
		}
	}
	...
	private void initMagic(String... file) {
		if(files.exists(file)) {
			...
			for(Element resource : spells.getChildren()) {
				...
				case "sign": resources.addResource(new RSign(resource), "magic"); break;
				case "tattoo": resources.addResource(new RTattoo(resource), "magic"); break;
				case "recipe": resources.addResource(new RRecipe(resource), "magic"); break;
				case "list": resources.addResource(new LSpell(resource), "magic"); break;
				case "power": resources.addResource(new RSpell.Power(resource), "magic"); break;
				case "enchant": resources.addResource(new RSpell.Enchantment(resource), "magic"); break;
				default: resources.addResource(new RSpell(resource), "magic"); break;				
				}
			}
		}
	}
	...
	private void initScripts(String... file) {
		try {
			for(String s : files.listFiles(file)) {
				...
				resources.addResource(script, "script");
			}
		} catch(Exception e) { 
	...
	private void initTasks(String... file) {
		...
		for(Element e : doc.getRootElement().getChildren()) {
			...
			RScript rs = (RScript)resources.getResource(e.getAttributeValue("script"), "script");
