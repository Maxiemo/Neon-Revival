...
public class EntitySerializer implements Serializer<Entity>, Serializable {
	...
	@Override
	public Entity deserialize(DataInput input, int available) throws IOException {
		switch(input.readUTF()) {
		case "item":
			return itemSerializer.deserialize(input, available);
		case "creature":
			return creatureSerializer.deserialize(input, available);
		default:
			return null;
		}		
	}
