...
public class LoadEvent extends EventObject {
	...
	private LoadEvent(Object source) {
		super(source);
	}
	...
	/**
	 * Used to indicate loading has finished.
	 * 
	 * @author mdriesen
	 */
	public static class Done extends LoadEvent {
		public Done(Object source) {
			super(source);
		}
	}
}
