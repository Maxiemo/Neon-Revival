...
public class MagicHandler {
	 ...
	 * @param me
	 */
	@Subscribe public void cast(MagicEvent.OnCreature me) {
	 ...
	 * @param me
	 */
	@Subscribe public void cast(MagicEvent.OnPoint me) {
	 ...
	 */
	@Subscribe public void cast(MagicEvent.CreatureOnPoint me) {
	 ...
	 */
	@Subscribe public void cast(MagicEvent.ItemOnPoint me) {
		Creature caster = me.getCaster();
		...
		if(formula == null) {
			...
			if(item instanceof Item.Scroll) {
				InventoryHandler.removeItem(caster, item);
			} else {
	 ...
	 * @return	the result of the cast
	 */
	@Subscribe public void cast(MagicEvent.ItemOnSelf me) {
		Item item = me.getItem();
		Creature caster = me.getCaster();
	 ...
	 * @return	the result of the cast
	 */
	@Subscribe public void cast(MagicEvent.OnSelf me) {
		Creature caster = me.getCaster();
		RSpell spell = me.getSpell();
